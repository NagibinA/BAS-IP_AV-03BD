...
|----------|----------|--------------|
| IP-адрес | IP-адрес панели BAS-IP | 192.168.1.90 |
...
- 📞 Исходящие SIP-звонки с выбором номера
- 🔔 Отслеживание нажатия кнопки вызова
- 🚪 Отслеживание состояния двери
- ⏰ Сенсор "дверь открыта слишком долго"

---

## 📊 Датчики

### Основные сенсоры (в диагностике)
...
| Сенсор | Описание |
|--------|----------|
| BAS-IP Doorbell | Нажатие кнопки вызова |
| BAS-IP Exit Button Pressed | Нажатие кнопки выхода |
| BAS-IP Door | Открыта/закрыта |
| BAS-IP Door Open Too Long | Дверь открыта > 120 сек |
| BAS-IP Exit Button Enabled | Функция кнопки выхода включена |
...
|-----|----------|----------|
| Кнопка | BAS-IP Reboot | Перезагрузка панели |
| Кнопка | BAS-IP Call | Исходящий звонок |
| Кнопка | BAS-IP Call End | Завершить звонок |
| Переключатель | BAS-IP Emergency Mode | Аварийный режим |
| Select | BAS-IP Call Number Select | Выбор номера для звонка |
| Number | BAS-IP Volume | Громкость (1-6) |
...
| basip.set_volume | Установить громкость | volume (1-6) |
